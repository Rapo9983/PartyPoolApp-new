...
export default function Dashboard({ onCreateEvent, onViewEvent, onEditEvent }: DashboardProps) {
  ...
  const [activeTab, setActiveTab] = useState<'my-events' | 'contributions'>('my-events');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-yellow-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex gap-2 mb-8 bg-white rounded-xl shadow-md p-2">
          <button
        ...
        {activeTab === 'my-events' ? (
          ...
          <ContributionHistory onViewEvent={onViewEvent} />
        )}
      </div>
