...
const translations = {
  en: {
    ...
    'footer.affiliation': 'As an affiliate, PartyPool earns from qualifying purchases. This does not affect the final price of your gift.',
  ...
  it: {
    ...
    'footer.affiliation': 'In qualità di affiliato, PartyPool riceve un guadagno dagli acquisti idonei. Questo non influisce sul prezzo finale del tuo regalo.',
