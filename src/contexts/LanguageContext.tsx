...
const translations = {
  en: {
    ...
    'footer.affiliation': 'As an Amazon Associate, PartyPool earns from qualifying purchases. This does not affect the final price of your gift.',
    ...
    'faq.question1': 'How much does PartyPool cost?',
    'faq.answer1': 'The service is completely free. There are no registration costs or commissions on collections, as PartyPool does not retain any percentage of contributions.',
    'faq.question2': 'Do guests need to register to contribute?',
    'faq.answer2': 'No, it\'s possible to contribute in a few seconds without an account. Registration is optional and only useful if you want to save and view the history of all gifts made over time.',
    'faq.question3': 'How does payment work?',
    'faq.answer3': 'PartyPool is an intermediary and coordinator — it does not manage an internal e-wallet. The app guides you to complete the payment directly via PayPal, Satispay or Cash. The money goes directly to the organizer, without passing through our systems.',
    'faq.question4': 'Are cash contributions allowed?',
    'faq.answer4': 'Yes! Guests can choose between "Digital Payment" (PayPal/Satispay) or "Cash Payment". Cash contributions will be marked as "promised" until the organizer manually confirms receiving them.',
    'faq.question5': 'Is my payment data safe?',
    'faq.answer5': 'Yes, because PartyPool never stores your financial data. Transactions take place exclusively on the secure external platforms (like PayPal or Satispay) that you already know.',
    'faq.question6': 'Can I edit an event after creating it?',
    'faq.answer6': 'Certainly! As an organizer, you can edit all the details (name, date, description, goal amounts and gift link) at any time directly from your dashboard.',
    'faq.question7': 'What happens if we don\'t reach the goal?',
    'faq.answer7': 'The organizer receives all contributions collected anyway. PartyPool is a coordination tool: there are no binding goals or fund blocks.',
    'faq.question8': 'How does "Equal Shares" mode work?',
    'faq.answer8': 'It\'s very simple: you specify the total cost of the gift and the number of friends who will participate. The app automatically calculates the exact share for each one, eliminating any awkwardness in asking for money.',
    'faq.question9': 'Can I contribute anonymously?',
    'faq.answer9': 'Yes. By selecting the "Anonymous" option, your name will not be visible to other guests, but only to the organizer (who needs to be able to verify the payment).',
    'faq.question10': 'Do I have to buy the gift on Amazon?',
    'faq.answer10': 'Absolutely not! You can add any link (Amazon, other stores, or no link). The Amazon affiliate function simply helps support PartyPool when you choose to use it, but it\'s completely optional.',
    'faq.question11': 'Can I share links to external stores?',
    'faq.answer11': 'Yes! You can add links to any online or physical store. If you prefer, you can also just describe the gift without adding any link. It\'s completely flexible.',
    'faq.question12': 'Can I create multiple events at the same time?',
    'faq.answer12': 'Certainly! There is no limit to the number of events you can organize. All of them will be conveniently manageable from your personal dashboard.',
  ...
  it: {
    ...
    'footer.affiliation': 'In qualità di Affiliato Amazon, PartyPool riceve un guadagno dagli acquisti idonei. Questo non influisce sul prezzo finale del tuo regalo.',
    ...
    'faq.question4': 'Sono permessi contributi in contanti?',
    'faq.answer4': 'Sì! Gli invitati possono scegliere tra "Pagamento Digitale" (PayPal/Satispay) o "Pagamento in Contanti". I contributi in contanti verranno segnati come "promessi" finché l\'organizzatore non confermerà manualmente di averli ricevuti.',
    ...
    'faq.question9': 'Posso contribuire in modo anonimo?',
    'faq.answer9': 'Sì. Selezionando l\'opzione "Anonimo", il tuo nome non sarà visibile agli altri invitati, ma solo all\'organizzatore (che deve poter verificare il pagamento).',
    'faq.question10': 'Devo per forza comprare il regalo su Amazon?',
    'faq.answer10': 'Assolutamente no! Puoi aggiungere qualsiasi link (Amazon, altri negozi, o nessun link). La funzione di affiliazione Amazon aiuta semplicemente a supportare PartyPool quando scegli di usarla, ma è completamente opzionale.',
    'faq.question11': 'Posso condividere link a negozi esterni?',
    'faq.answer11': 'Sì! Puoi aggiungere link a qualsiasi negozio online o fisico. Se preferisci, puoi anche solo descrivere il regalo senza aggiungere alcun link. È completamente flessibile.',
    'faq.question12': 'Posso creare più eventi contemporaneamente?',
    'faq.answer12': 'Certamente! Non c\'è limite al numero di eventi che puoi organizzare. Tutti saranno comodamente gestibili dalla tua dashboard personale.',
